  ...
  return (
    ...
    >
      <div className={` flip-card-inner ${isExpanded ? 'flipped' : ''}`}>
        ...
        {/* Back side */}
        <div className='feedback-container flip-card-back'>
          <div className='grid grid-flow-col grid-rows-2 expanded-content'>
            <div className='flex flex-row items-center rounded-[10px] mb-2'>
              <img src={quotes} alt='discount' className='w-[32px] h-[32px]' />
            ...
            {apps.map((app, index) => (
              <div
                key={index}
                className='grid grid-flow-col items-center w-full p-2 m-2 bg-white rounded-md cursor-pointer'
              ...
              >
                ...
                <a
                  ...
                  className='text-black text-[16px] font-semibold text-white'
                >
                  {app.name}
                </a>
              </div>
